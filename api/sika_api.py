...
app = Flask(__name__)
IM_SCALED_SIZE = 2048, 2048 # Max size for tensorflow work
...
def predict():
    ...
    if file:
        ...
        #full_filename = '/home/fer/repos/dw_a/dll_package_recognition/pkrecog_031_0006.jpg'
        ...
        class_squeeze = classes.astype(np.int32)
        boxes_squeeze = boxes
        scores_squeeze = scores
